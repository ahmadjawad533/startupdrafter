 ...
 * These interfaces define the contract between the frontend and the API Gateway backend.
 * While this is a JavaScript file, these type definitions are documented for reference
 * and can be used in TypeScript projects that consume this API.
 *
 * ============================================================================
 * REQUEST MODELS
 * ============================================================================
 ...
 * @property {string} userId - Unique user identifier (UUID v4 format)
 * @property {string} notes - Raw, unformatted work notes from the user
 * 
 * Request body sent to POST /generate endpoint.
 * Example:
 * {
 ...
 * @property {boolean} success - Indicates successful API operation
 * @property {string} [statusUpdate] - Generated professional status update (present if success=true)
 * @property {string} [timestamp] - ISO 8601 timestamp when the update was generated (present if success=true)
 * @property {string} [error] - Error message describing what went wrong (present if success=false)
 * 
 * Response from POST /generate endpoint (HTTP 200).
 * Success Example:
 * {
 *   "success": true,
 ...
 * @property {boolean} success - Indicates successful API operation
 * @property {UpdateRecord[]} updates - Array of update records from the user's history
 * @property {string} [error] - Error message if operation failed
 * 
 * Response from GET /history endpoint (HTTP 200).
 * The updates array is sorted by timestamp in descending order (newest first).
 * Example:
 * {
 *   "success": true,
 *   "updates": [
 ...
 * @property {string} timestamp - ISO 8601 timestamp when the update was generated (e.g., "2024-01-15T10:30:45.123Z")
 * @property {string} statusUpdate - Formatted professional status update containing Done, In Progress, and Blockers sections
 * @property {string} originalNotes - The raw, original notes provided by the user before formatting
 * 
 * Represents a single stored update record from the user's history.
 * This object is part of the HistoryResponse.updates array.
 *
 * ============================================================================
 ...
 * @property {string} userId - Unique user identifier (UUID v4 format)
 * @property {string} createdAt - ISO 8601 timestamp when the user was first identified
 * 
 * Stored in browser localStorage under key 'standupDrafter_user'.
 * Example:
 * {
 *   "userId": "a1b2c3d4-e5f6-7890-abcd-ef1234567890",
